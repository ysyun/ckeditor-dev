...
CKEDITOR.dialog.add("base64imageDialog", function (editor) {
    ...
    function imagePreviewLoad(s) {
        ...
        i.onload = function () {
            ...
            if (orgWidth == null && orgHeight == null) {
                var editorH = editor.container.$.offsetHeight - 20;
                var editorW = editor.container.$.offsetWidth - 20;
            ...
            this.setAttribute("style", "max-width:500px;max-height:300px;");
    ...
    /* Dialog */
    return {
        title: editor.lang.common.selectimage,
        minWidth: 550,
        minHeight: 380,
        onFocus: function () { },
        onLoad: function () {
            ...
            if (fsupport) {
                ...
                /* Checkbox Events */
                if (urlCB) urlCB.getInputElement().on("click", function () {
                    imagePreview("url");
                });
                if (fileCB) fileCB.getInputElement().on("click", function () {
                    imagePreview("file");
                });
        ...
        onShow: function () {
            ...
            t.setValueOf("tab-properties", "align", "center");
            if (selectedImg) {
                ...
                if (k == "align") {
                    switch (value) {
                        ...
                        case "right":
                            ...
                            break;
                        case "center":
                            attr[k][1] = 'display:block;margin-left:#;margin-right:#;';
                            cssvalue = 'auto';
                            break;
                        default:
                            value = null;
