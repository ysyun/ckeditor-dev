...
(function () {
    ...
    CKEDITOR.plugins.add('image3', {
        ...
        init: function (editor) {
            ...
            // when we'll rename image3 to image.
        ...
        return {
            ...
            data: function () {
                ...
                this.parts.image.setAttributes({
                    ...
                    // 'data-cke-saved-src': 'base64image',
            ...
            init: function () {
                ...
                // for widget plugin: when add widget_wrapper_readonly, widget outline/moveicon is none by pyun
                editor.on('readOnly', function (evt) {
                    if (editor.readOnly) {
                        this.element.getParent().addClass('widget_wrapper_readonly');
                    } else {
                        this.element.getParent().removeClass('widget_wrapper_readonly');
                    }
                }, this);
            },
        ...
        return function (value) {
            ...
            if (value in {
                ...
                command.on('exec', function (evt) {
                    ...
                    if (widget) {
                        if (editor.plugins && editor.plugins.dragresize) {
                            editor.fire('hideHandle');
                        }
        ...
        var alignClasses = editor.config.image3_alignClasses,
            rules = {
                ...
                img: {
                    ...
                    classes: 'border-style,border-width,float,height,margin,margin-bottom,margin-left,margin-right,margin-top,width'
                },
                figure: {
 ...
 *
 * Read more in the [documentation](#!/guide/dev_image3) and see the
 * [SDK sample](https://sdk.ckeditor.com/samples/image3.html).
 *
