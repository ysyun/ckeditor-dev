...
(function(window, document, undefined) {
    ...
    function ColorPicker(slideElement, pickerElement, callback) {
        ...
        if (type == 'SVG') {
            ...
            var hsvGradient = slideClone.querySelector('#gradient-hsv');
            ...
            var blackAndWhiteGradients = [pickerClone.querySelector('#gradient-black'), pickerClone.querySelector('#gradient-white')];
